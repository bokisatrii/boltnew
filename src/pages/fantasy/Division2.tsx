...
const Division2: React.FC = () => {
  return (
    <>
      <SEO
        title="Fantasy Division 2 - Corner Three Fantasy League"
        description="Corner Three Fantasy Basketball Division 2 standings and stats. Join the competition in our second fantasy basketball division."
        keywords="fantasy basketball division 2, Corner Three fantasy league, fantasy basketball standings"
        url="/fantasy/division-2"
      />
      ...
      <div className="pt-28 pb-16 bg-white">
        <div className="container">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">Division 2</h1>
            <p className="text-gray-600">The development division of the Corner Three Fantasy Basketball League</p>
          </motion.div>
